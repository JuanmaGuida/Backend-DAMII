...
public class CatalogController {
    ...
    @GetMapping(value = "/neighborhoods", produces = MediaType.APPLICATION_JSON_VALUE)
    public List<NeighborhoodResponse> getNeighborhoods() {
        return neighborhoodService.findAll();
    }

    @GetMapping(value = "/neighborhoods/{neighborhoodId}", produces = MediaType.APPLICATION_JSON_VALUE)
    public NeighborhoodResponse getNeighborhood(@PathVariable UUID neighborhoodId) {
